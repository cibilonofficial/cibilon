...
/** Document checklist per service. Only PAN Card, Aadhaar Card, and Address Proof are mandatory; all others optional. */
export const DOCUMENT_CHECKLIST: Record<ServiceType, { name: string; required: boolean }[]> = {
  'Personal Loan': [
    ...
    { name: 'Salary Slips (3 months)', required: false },
    { name: 'Bank Statements (6 months)', required: false },
    { name: 'Photograph', required: false },
  ...
  'Business Loan': [
    ...
    { name: 'Aadhaar Card', required: true },
    { name: 'Address Proof', required: true },
    { name: 'Business Proof', required: false },
    { name: 'GST Documents', required: false },
    { name: 'ITR (2 years)', required: false },
    { name: 'Bank Statements (12 months)', required: false },
    { name: 'Photograph', required: false },
  ...
  'Vehicle Loan': [
    ...
    { name: 'Address Proof', required: true },
    { name: 'Bank Statements (6 months)', required: false },
    { name: 'Proforma Invoice', required: false },
